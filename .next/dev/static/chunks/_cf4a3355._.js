...
const useAppStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        // Announcements
        announcements: [],
        setAnnouncements: (announcements)=>set({
                announcements
            }),
        ...
        teamsMessages: [],
        setTeamsMessages: (messages)=>set({
                teamsMessages: messages
            }),
        addTeamsMessage: (message)=>set((state)=>({
                    teamsMessages: [
                        message,
                        ...state.teamsMessages
                    ]
        ...
        // Help Tickets
        helpTickets: [],
        setHelpTickets: (helpTickets)=>set({
                helpTickets
            }),
        addHelpTicket: (ticket)=>set((state)=>({
                    helpTickets: [
                        ticket,
                        ...state.helpTickets
                    ]
                })),
        updateHelpTicket: (id, updates)=>set((state)=>({
                    helpTickets: state.helpTickets.map((t)=>t.id === id ? {
                            ...t,
                            ...updates
                        } : t)
                })),
        ...
        performSearch: (query)=>{
            ...
            const announcements = state.announcements.filter((a)=>a.title.toLowerCase().includes(lowerQuery) || a.content.toLowerCase().includes(lowerQuery));
            const events = state.events.filter((e)=>e.title.toLowerCase().includes(lowerQuery) || e.description.toLowerCase().includes(lowerQuery));
...
function AuthProvider({ children }) {
    _s();
    const { user, setUser, updateUserProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email, password)=>{
            ...
            // Simulate API call
            await new Promise({
                "AuthProvider.useCallback[login]": (resolve)=>setTimeout(resolve, 1500)
            }["AuthProvider.useCallback[login]"]);
            // Simple validation (in production, this would be a real API call)
            if (email && password) {
                const newUser = {
                    id: "1",
                    name: email.split("@")[0].replace(/\./g, " ").replace(/\b\w/g, {
                        "AuthProvider.useCallback[login]": (l)=>l.toUpperCase()
                    }["AuthProvider.useCallback[login]"]),
                    email: email,
    ...
    const loginWithMicrosoft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[loginWithMicrosoft]": async ()=>{
            setIsLoading(true);
            // Simulate Microsoft OAuth flow
            await new Promise({
                "AuthProvider.useCallback[loginWithMicrosoft]": (resolve)=>setTimeout(resolve, 2000)
            }["AuthProvider.useCallback[loginWithMicrosoft]"]);
    ...
    const hasDepartment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[hasDepartment]": (departments)=>{
            if (!user) return false;
            if (departments.includes("all")) return true;
            return departments.includes(user.department);
        }
    }["AuthProvider.useCallback[hasDepartment]"], [
        user
    ]);
...
_s(AuthProvider, "NUfKoVbFdQTvcYztJJqigZ5JHtE=", false, function() {
    return [
...
//# sourceMappingURL=_cf4a3355._.js.map